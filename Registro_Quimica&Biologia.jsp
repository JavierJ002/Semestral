...
<html lang="es">
  ...
  <body>
    <header>
      ...
      <div class="Titulo">
        <h1>Registro Quimica y Biologia</h1>
      </div>
    ...
    <section id="principal">
      ...
      <% /*obtencion de los valores para colocarlos en la tabla luego*/
    	...
    	%>
			...
			String insertarsql = "INSERT INTO regs_bioqui (Nombre, Cedula, Fecha_In) VALUES ('" +Nombre+ "','" +Cedula+ "','" +Fecha+"')";
