    ...
    <section id="principal">
      ...
      <% /*obtencion de los valores para colocarlos en la tabla luego*/
    	...
    	%>
			...
			String insertarsql = "INSERT INTO regs_prog (Nombre, Cedula, Fecha_In) VALUES ('" +Nombre+ "','" +Cedula+ "','" +Fecha+"')";
    ...
    <footer>
      <div class="footer-container">
        <div class="footer-row">
          ...
          <a href="Registro_Profesor.html" class="footer-button">Registro Ciencias Naturales</a>
          <a href="Registro_Estudiante.html" class="footer-button">Registro Química y Biología</a>
          <a href="#" class="footer-button logout-button" style="margin-left: auto;">LogOut</a> <!-- Botón LogOut añadido -->
        </div>
        <div class="footer-row">
          <a href="Calendario.html" class="footer-button">Registro Programación</a>
